...
function Home({ title, id, price, img, roomCount, metergae }) {
  return (
    <div class="card">
      ...
      <div class="card__details">
        ...
        <p class="card__text">{metergae} متر مربع</p>
        <span class="">
          <i class="fa fa-key card__icon"></i>
        </span>
        <p class="card__text">{price.toLocaleString()}</p>
      </div>

      <Link href={""} class="btn btn-brown btn-card">
        مشاهده ملک
      </Link>
    </div>
  );
